...
const PreviewShell: React.FC = () => {
  ...
  // keep the host fixed and non-scrollable so the iframe doesn't shift with host scrolling
  ...
  // innerWrapper overflow controlled by the viewer frame depending on zoom level
  ...
  React.useEffect(() => {
    const previewContainer = document.querySelector('.page-editor-preview-container') as HTMLElement | null;
    const host = document.getElementById('vivlio-preview-container');
    if (!previewContainer || !host || !isOpen) return;
