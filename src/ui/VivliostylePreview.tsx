        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
            ...
            <span style={{ marginLeft: 'auto' }}>
              <button
                ...
                style={{
                  border: 'none', background: 'transparent', cursor: 'pointer', fontSize: 16, lineHeight: 1, padding: 0, color: '#555'
                }}
          ...
          {fullHtml && (
            <details style={{ marginTop: 8 }}>
              ...
              <pre style={{ maxHeight: 200, overflow: 'auto', background: '#f5f5f5', padding: 8, border: '1px solid #eee' }}>{fullHtml.slice(0, 1200)}</pre>
            </details>
          )}
        </div>
      )}
