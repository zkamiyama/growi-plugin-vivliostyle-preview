      ...
      <div style={{ height: '100%', width: '100%', position: 'relative' }}>
        {vivlioPayload && (() => {
          ...
          const minimalShell = `<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1" /><title>Vivlio Preview</title><style>
            ...
            /* pages themselves (spread container contents) should remain white and use a subtle shadow instead of a hard border */
            .vivliostyle-page, .page, [data-vivliostyle-page-container] { background: white; box-shadow: 0 6px 18px rgba(0,0,0,0.28); box-sizing: border-box; }
