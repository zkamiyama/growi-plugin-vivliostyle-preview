...
function post(html: string, css?: string | null){
  ...
  f.contentWindow.postMessage({type:'HTML_FULL', html, css, full, progressive: true, pageWidth: lastPageWidthPx||null}, '*');
}
