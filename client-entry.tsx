...
import BuildPdfMenuInjector from './src/ui/components/BuildPdfMenuInjector';
import BuildPdfDialog from './src/ui/components/BuildPdfDialog';
// Ensure standalone menu injection runs as early as possible (independent of React mount)
import './src/ui/components/MenuInjectorStandalone';
...
function mount() {
  ...
  if (!previewContainer) {
    // eslint-disable-next-line no-console
    console.debug('[VivlioDBG][mount] previewContainer not found, scheduling retry (200ms) while continuing with fallback mount');
    setTimeout(() => {
