...
function ensureIframe(): HTMLIFrameElement {
  ...
  // Always ensure panel exists and attach iframe to it.
  const panel = vivlioPanel || ensureVivlioPanel();
  if (panel) {
    panel.innerHTML = '';
    panel.appendChild(iframe);
  } else {
    console.error(LOG_PREFIX, 'Failed to create or find vivlio-panel. Iframe cannot be attached.');
  }
